...
export default {
  ...
  methods: {
    ...
    ratio(row, col) {
      ...
      //var scale = [1, 3/2, 4/3, 5/3, 5/4, 6/5, 7/6, 7/5, 7/4, 8/7, 8/5, 9/8, 9/7, 9/5, 10/9, 10/7, 11/10, 11/9, 11/8, 11/7, 11/6,12/11, 12/7, 13/12, 13/11,13/10,13/9,13/8,13/7] //Partials
      ...
      //var scale = [1,25/24, 8/7,25/21, 4/3,25/18, 8/5, 5/3, 2];
      //var scale = [1, 1.118286868212, 1.143572939716, 1.278842601327, 1.337329378409, 1.495517882348, 1.599276462233, 1.788449866355, 2];
      //var scale = [1, 10/9, 8/7, 9/7, 4/3, 3/2, 8/5, 16/9, 2];
      //var scale = [1, 16/15, 8/7, 1.24444, 4/3, 1.493333, 8/5,1.86666, 2]; //1.75, 2, 7/6, 1.4,
      //var scale = [ 1, 16/15, 28/25, 1.1428571428571428, 1.1666666666666665, 1.2000000000000002, 1.25, 1.3333333333333333, 1.4000000000000001, 1.4285714285714284, 1.5, 1.6, 1.6666666666666665, 1.7142857142857142, 1.75, 2 ]
      //var scale = [12/12, 12/11, 12/10, 12/9, 12/8, 12/7, 12/6];
      //var scale = [8/4, 8/5, 8/6, 8/7, 8/8];
      //var scale = [1, 9/8, 5/4, 3/2, 7/4 ];
      ...
      //var scale2 = [1, 35/32];
      //var scale2 = [1, 36/35,21/20, 48/45, 27/25];
      //var scale2 = [1, 36/35, 25/24, 15/14, 35/32];
      //var scale2 = [1, 50/49, 21/20, 16/15, 15/14, 27/25];
      ...
      //var scale2 = [1, 5/4, 3/2, 15/8];
      //var scale2 = [1, 1.250565519615, 1.495517882348, 1.748904622119, 2];
      ...
      //Multiply
      //var r = s * s2;
      //var r = scale[(col - 1) % scale.length] * scale2[(row - 1) % scale2.length];
      //var r = scale[(col - 1) % scale.length] * scale2[scale2.length - ((row - 1) % scale2.length) - 1];
